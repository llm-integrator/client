/** Совпадают с дефолтами на сервере для новых подключений. */
export const DEFAULT_SELF_REMINDER_TEXT =
  'Напоминаю: я в чате — позовите меня упоминанием, если нужна помощь.';
