...
export const help = {
  ...
  selfReminderSkippedMessagesThreshold: {
    title: 'Пропуск сообщений перед повтором',
    content: (
      <Paragraph style={{ marginBottom: 0 }} type="secondary">
        Сколько сообщений зрителей бот должен пропустить после своего последнего сообщения, прежде
        чем отправит следующее напоминание. Условие работает вместе с интервалом: напоминание
        уйдёт только когда прошли и секунды, и нужное количество сообщений. Значение{' '}
        <Text strong>0</Text> отключает проверку по количеству сообщений.
      </Paragraph>
    ),
  },
  selfReminderMode: {
